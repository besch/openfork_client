...
IMAGES: List[ImageConfig] = [
    ...
    ImageConfig("Dockerfile.hunyuan-video-diagdistill", "beschiak/openfork-diagdistill:latest", build=True, push=True),
    ...
    # ImageConfig("Dockerfile.ltx23-16gb", "beschiak/openfork-ltx23-16gb:latest", build=False, push=True),
    # ImageConfig("Dockerfile.ltx23-24gb", "beschiak/openfork-ltx23-24gb:latest", build=False, push=True),
