...
class WAN22DimensionTests(unittest.TestCase):
    ...
    def test_24gb_tier_uses_highest_successful_16_by_9_resolution(self):
        self.assertEqual(
    ...
    def test_24gb_tier_rounds_explicit_probe_dimensions_to_multiple_of_16(self):
        self.assertEqual(
            resolve_wan22_dimensions(
                "16:9",
    ...
    def test_text_to_video_injects_explicit_24gb_dimensions(self):
        workflow = {
            "prompt": {
                "6": {"class_type": "CLIPTextEncode", "inputs": {"text": ""}},
                "7": {"class_type": "CLIPTextEncode", "inputs": {"text": ""}},
        ...
        self.assertEqual((graph["9"]["inputs"]["width"], graph["9"]["inputs"]["height"]), (1280, 720))
