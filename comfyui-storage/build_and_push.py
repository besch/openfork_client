...
OPTIONAL_IMAGES: List[ImageConfig] = [
    ...
    ImageConfig("Dockerfile.qwen-8gb", "beschiak/openfork-qwen-8gb:latest", build=True, push=True, direct_push=True),
    ImageConfig("Dockerfile.qwen-turbo-8gb", "beschiak/openfork-qwen-image-turbo-8gb:latest", build=True, push=True, direct_push=True),
    ImageConfig("Dockerfile.krea2-turbo-8gb", "beschiak/openfork-krea2-turbo-8gb:latest", build=True, push=True, direct_push=True),
    ImageConfig("Dockerfile.krea2-turbo-16gb", "beschiak/openfork-krea2-turbo-16gb:latest", build=True, push=True, direct_push=True),
    ImageConfig("Dockerfile.krea2-turbo-24gb", "beschiak/openfork-krea2-turbo-24gb:latest", build=True, push=True, direct_push=True),
