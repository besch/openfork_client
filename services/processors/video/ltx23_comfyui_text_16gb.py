"""LTX-2.3 Text-to-Video Processor (ComfyUI backend, 16GB VRAM)."""
...
class LTX23ComfyUITextToVideoProcessor16GB(ComfyUIProcessor, VideoOutputHandler):
    """ComfyUI-based LTX-2.3 T2V processor, 16GB tier (576x320, 97 frames)."""
    ...
    def process(self):
        ...
        wf_ready = inject_prompt_into_ltx23_video_workflow(
            ...
            aspect_ratio, steps=steps, cfg_scale=cfg_scale, tier="16gb",
        )
        ...
        logging.info(
            f"LTX-2.3 ComfyUI T2V 16GB job {self.job_id} completed: {video_storage_path}"
        )
