"""
LTX-Video Image-to-Video Processor
"""
...
class LTXImageToVideoJobProcessor(ComfyUIProcessor, VideoOutputHandler):
    """Processor for LTX-Video image-to-video generation."""
    ...
    def process(self):
        ...
        if not self.job:
            self._fail_job(f"Job object is None for LTXImageToVideoJobProcessor. Cannot proceed.")
            return
