"""LTX-2.3 Text-to-Video Processor (ComfyUI backend, 8GB VRAM)."""
...
class LTX23ComfyUITextToVideoProcessor8GB(ComfyUIProcessor, VideoOutputHandler):
    ...
    def process(self):
        ...
        wf_ready = inject_prompt_into_ltx23_video_workflow(
            ...
            aspect_ratio, steps=steps, cfg_scale=cfg_scale, tier="8gb",
        )
        ...
        logging.info(
            f"LTX-2.3 ComfyUI T2V 8GB job {self.job_id} completed: {video_storage_path}"
        )
